...
const PrimaryButton = ({
  ...
  // variant별 스타일 정의
  const solidStyles =
    'bg-mint-300 dark:bg-mint-350 hover:bg-mint-400 text-gray-25 disabled:bg-gray-100 disabled:hover:bg-gray-100 dark:disabled:bg-gray-100';
  const outlineStyles =
    'border border-mint-300 dark:border-mint-350 hover:border-mint-400 text-mint-300 hover:text-mint-400 bg-transparent disabled:border-gray-100 disabled:hover:border-gray-100 disabled:text-gray-100 disabled:hover:text-gray-100';
